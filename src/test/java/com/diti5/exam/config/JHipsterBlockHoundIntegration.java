...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.diti5.exam.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.diti5.exam.security.DomainUserDetailsService", "createSpringSecurityUser");
